...
class KeyTeleop():
    ...
    def __init__(self, interface):
        ...
        self._pub_cmd = rospy.Publisher('/robot_vel_goal', Pose2D, queue_size=10)
...
class SimpleKeyTeleop():
    def __init__(self, interface):
        ...
        self._forward_rate = rospy.get_param('~forward_rate', 0.25)
    ...
    def _publish(self):
        ...
        twist = self._get_twist(self._linear, self._angular)
        vel_goal = Pose2D()
        vel_goal.y = twist.linear.x
        vel_goal.theta = twist.angular.z
        self._pub_cmd.publish(vel_goal)
